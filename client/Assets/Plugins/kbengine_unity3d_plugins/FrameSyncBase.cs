/*
	...
	Please inherit this module, such as: (class FrameSync : FrameSyncBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	public abstract class FrameSyncBase : EntityComponent
	{
		public EntityBaseEntityCall_FrameSyncBase baseEntityCall = null;
		public EntityCellEntityCall_FrameSyncBase cellEntityCall = null;
		...
		public override void createFromStream(MemoryStream stream)
		{
			...
			baseEntityCall = new EntityBaseEntityCall_FrameSyncBase(entityComponentPropertyID, ownerID);
			cellEntityCall = new EntityCellEntityCall_FrameSyncBase(entityComponentPropertyID, ownerID);
		}
